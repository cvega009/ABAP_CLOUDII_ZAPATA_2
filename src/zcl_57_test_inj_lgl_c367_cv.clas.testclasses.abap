...
CLASS ltcl_test_inj DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA: mo_cut TYPE REF TO zcl_57_test_inj_lgl_c367_cv.
...
CLASS ltcl_test_inj IMPLEMENTATION.
  ...
  METHOD get_customer_test.
    ...
    EXPORTING act = |{ ls_customer-customer_id }-{ ls_customer-country_code }|
      ...
      cl_abap_unit_assert=>fail( 'Get customer process failed--> zcl_57_test_inj_lgl_c367_cv->get_customer' ).
  ...
  METHOD setup.
    me->mo_cut = NEW zcl_57_test_inj_lgl_c367_cv(  ).
